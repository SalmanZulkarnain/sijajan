...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql_login_user = "SELECT * FROM sijajan_user WHERE email = '$email' AND password = '$password'";
    ...
    if ($eksekusi_login_user->num_rows > 0) {
        ...
        } elseif($user['level_user'] == 'pengguna') {
            echo "<script>
...
<body>
    <div class="pure-g wrap-card">
        <div class="pure-u-1 pure-u-md-1-2 card-1">
            <h1>Selamat Datang di Sijajan</h1>
            <h4>Aplikasi berjajan ria</h4>
